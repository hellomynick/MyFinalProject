...
namespace WebOrder.Services.Catalog.API.Infrastructure
{
    ...
    public class CatalogContextSeed
    {
        ...
        private IEnumerable<CatalogItem> GetCatalogItemsFromFile(string contentRootPath, CatalogContext context, ILogger<CatalogContextSeed> logger)
        {
            ...
            try
            {
                string[] requiredHeaders = { "catalogtypename", "storeid", "description", "name", "price", "picturefilename" };
            ...
            return File.ReadAllLines(csvFileCatalogItems)
                        ...
                        .SelectTry(column => CreateCatalogItem(column, csvheaders, catalogTypeIdLookup))
                        .OnCaughtException(ex => { logger.LogError(ex, "EXCEPTION ERROR: {Message}", ex.Message); return null; })
                        .Where(x => x != null);
        }

        private CatalogItem CreateCatalogItem(string[] column, string[] headers, Dictionary<String, int> catalogTypeIdLookup )
        {
            ...
            {
                StoreId = column[Array.IndexOf(headers, "storeid")].Trim('"').Trim(),
        ...
        private IEnumerable<CatalogItem> GetPreconfiguredItems()
        {
            ...
            {
                new CatalogItem {StoreId="e7132e00-7db3-4af9-97c8-453070dbc273", CatalogTypeId = 1, AvailableStock = 100, Description = "Cafe", Name = "Capuchino", Price = 19.5M, PictureFileName = "1.png" },
                new CatalogItem {StoreId="e7132e00-7db3-4af9-97c8-453070dbc273", CatalogTypeId = 1, AvailableStock = 100, Description = "Milk", Name = "Milk", Price= 8.50M, PictureFileName = "2.png" },
                new CatalogItem {StoreId="e7132e00-7db3-4af9-97c8-453070dbc273", CatalogTypeId = 2, AvailableStock = 100, Description = "Rice", Name = "Rice", Price = 12, PictureFileName = "3.png" },
                new CatalogItem {StoreId="e7132e00-7db3-4af9-97c8-453070dbc273", CatalogTypeId = 2, AvailableStock = 100, Description = "Noodle", Name = "Noodle", Price = 12, PictureFileName = "4.png" },
            };
        }
