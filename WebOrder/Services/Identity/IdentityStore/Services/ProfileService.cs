...
namespace IdentityStore.API.Services
{
    public class ProfileService : IProfileService
    {
        ...
        public ProfileService(UserManager<ApplicationStore> userManager)
        {
        ...
        private IEnumerable<Claim> GetClaimsFromUser(ApplicationStore user)
        {
            ...
            if (!string.IsNullOrWhiteSpace(user.Close))
                claims.Add(new Claim("close", user.Close));
