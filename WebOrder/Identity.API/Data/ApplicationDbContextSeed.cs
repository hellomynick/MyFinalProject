...
namespace Identity.API.Data
{
    public class ApplicationDbContextSeed
    {
        ...
        public IEnumerable<ApplicationUser> GetUsersFromFile(string contentRootPath, ILogger logger)
        {
            ...
            try
            {
                string[] requiredHeaders = {
                    ...
                    "username","securitynumber","studentcard",
        ...
        IEnumerable<ApplicationUser> GetDefaultUser()
        {
            var user =
            new ApplicationUser()
            {
